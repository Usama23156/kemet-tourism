    ...
    <>
     <div className='flex justify-center items-center flex-col pt-6 gap-y-8 '>
      <div>
        ...
        <img data-aos="fade-left"  src="/last-Round-Trip-2.png" alt="" className='lg:max-w-2xl md:max-w-lg absolute overflow-x-hidden'/>
        </div>
        ...
        <div className='flex justify-center items-center overflow-x-hidden'>
          ...
          <img data-aos="fade-left" src="/Triangles-3.png" alt="" className='lg:max-w-2xl md:max-w-xl max-w-96 absolute overflow-x-hidden' />
        </div>
