...
function page() {
  return (
    <>
     <div className='flex justify-center items-center flex-col pt-6 gap-y-8 overflow-x-hidden'>
      <div>
    ...
    className="lg:max-w-2xl md:max-w-lg absolute animate-path overflow-x-hidden"
/>
        </div>
