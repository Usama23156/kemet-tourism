    ...
    <>
     <div className='flex justify-center items-center flex-col pt-6 gap-y-8 '>
      <div>
        ...
        <img data-aos="fade-left"  src="/last-round-trip-3.png" alt="" className='lg:max-w-2xl md:max-w-lg absolute '/>
        <img data-aos="fade-up"  src="/last-round-trip-4.png" alt="" className='lg:max-w-2xl md:max-w-lg '/>
        <img data-aos="fade-right"  src="/last-Round-Trip-2.png" alt="" className='lg:max-w-2xl md:max-w-lg absolute min-w-56 '/>
        </div>
