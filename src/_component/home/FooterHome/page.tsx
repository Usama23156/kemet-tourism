  ...
  return (
    ...
    <div className="lg:flex justify-center items-center gap-y-6 gap-x-12">
      <div className='  pt-6 gap-x-3 relative'>               
        <img src="/IMG_0947.jpg" alt="" className='lg:max-w-xl rounded-lg'/>
        <h3 className='pt-9 text-2xl md:text-4xl lg:text-5xl absolute bottom-3 left-2'>Let's plan your next trip</h3>
      </div>
