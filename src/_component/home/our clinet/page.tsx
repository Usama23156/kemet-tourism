    ...
    <>
      <div className="pt-9 pb-9 relative flex justify-center items-center flex-col gap-y-6">
        ...
        <div className="flex flex-col justify-center items-center mt-6 gap-y-1 md:gap-y-6 absolute bottom-12 md:bottom-14">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold">Our Favorite Travelers</h2>
          <Swiper
          ...
          <button className="client-prev absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-white/80 hover:bg-white p-2 rounded-full shadow-lg transition-colors">
            <ChevronLeft className="h-6 w-6 text-gray-600" />
          </button>
          <button className="client-next absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-white/80 hover:bg-white p-2 rounded-full shadow-lg transition-colors">
