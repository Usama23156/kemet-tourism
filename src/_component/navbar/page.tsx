  ...
  return (
    ...
    <div className='fixed z-[1000] right-0 top-0 w-full'>
      <div className={`flex justify-between items-center transition-[0.5s] px-6 lg:px-[100px] md:py-0 ${scrollPosition < 50 ? '' : 'opacity-70 bg-[#0C1135]' } ${isVisible ? 'top-0' : 'top-24'}`}>
        ...
        <div className={`${open ? "flex bg-blue-950 absolute md:relative top-16 left-0 w-full h-auto mt-6" : "hidden"} md:flex flex-col md:flex-row items-center md:justify-between md:space-x-12 lg:space-x-40 w-full md:w-auto md:mt-0 md:bg-transparent p-6 md:p-0 rounded-lg md:rounded-none`}>
